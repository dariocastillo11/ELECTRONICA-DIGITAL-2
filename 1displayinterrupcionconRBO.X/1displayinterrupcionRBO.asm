...
;---------------------CONFIGURO INT-------------------------
    ...
    BANKSEL	PORTA
   ; BCF		INTCON,RBIF	    ;borra el flag de interrupcion de NIVEL
    BCF		INTCON,INTF	    ;BORRA FLAG INTERRUPCION DEL RBO  DE FLANCO
    ;BANKSEL	IOCB
  ;  BSF		IOCB,7		  ;SETEA  PIN DE INTERRUPCION POR NIVEL
   ; BSF		INTCON,3		   ;  SETEA    RBIE  PARA TODO EL PUERTO B INTERRUPCION POR NIVEL
...
INTERRUPCION:	
   ...
   ; BCF		INTCON,RBIF	;LIMPIO FLAF,.. ESTO ES PARA INTERRUPCION POR NIVEL
